      ...
      <section className="bg-gray-200 py-24">
        <div className="limit text-gray-600">
            ...
            <div className="sm:flex pt-16">
                <div className="bg-white p-8 rounded-lg shadow w-64 flex flex-col">
                    <p className="font-extrabold text-xl flex-grow">Student</p>
                    <p className="text-3xl text-center mt-16">Bez naknade</p>
                    <p className="opacity-50 text-sm text-center">Svi studenti dodiplomskih, diplomskih i doktorskij studija te nezaposleni.</p>
                </div>
                <div className="bg-white mt-8 sm:mt-0 sm:ml-12 p-8 rounded-lg shadow w-64">
                    <p className="font-extrabold text-xl flex-grow">Član</p>
                    <p className="text-5xl text-center mt-16 leading-none">20€</p>
      ...
      <section className="bg-gray-200 py-24">
        <div className="limit text-gray-600">
            ...
            <ul className="mt-12 text-lg">
                <li>Primatelj: <span className="font-semibold">HDIR, Bijenička 54, 10000 Zagreb</span></li>
                <li>IBAN primatelja: <span className="font-number font-medium">HR5023600001102084564</span></li>
                <li>Opis plaćanja: <span className="font-semibold">Vaše ime i prezime – članarina za 2020.</span></li>
            </ul>
        </div>
      </section>
    </div>
